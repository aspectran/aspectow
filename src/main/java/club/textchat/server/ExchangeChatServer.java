...
/**
 * WebSocket endpoint for the exchange chat server.
 *
 * <p>Created: 29/09/2019</p>
 */
@Component
@ServerEndpoint(
        value = "/chat/exchange/{token}",
        encoders = ChatMessageEncoder.class,
        decoders = ChatMessageDecoder.class,
        configurator = ChatServerConfigurator.class
)
public class ExchangeChatServer {

    private final ExchangeChatHandler chatHandler;

    @Autowired
    public ExchangeChatServer(ExchangeChatHandler chatHandler) {
