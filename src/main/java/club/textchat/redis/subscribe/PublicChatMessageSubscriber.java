...
@Component
@Bean
public class PublicChatMessageSubscriber extends RedisPubSubAdapter<String, String>
        implements InitializableBean, DisposableBean {

    private static final Logger logger = LoggerFactory.getLogger(PublicChatMessageSubscriber.class);
    ...
    @Autowired
    public PublicChatMessageSubscriber(RedisConnectionPool connectionPool,
    ...
    public void message(String channel, String message) {
        ...
        if (broadcastPayload != null) {
            chatHandler.send(chatMessage, broadcastPayload.getRoomId());
            ...
            chatHandler.send(chatMessage, userLeftPayload.getRoomId()); // talker already left
        }
    }
