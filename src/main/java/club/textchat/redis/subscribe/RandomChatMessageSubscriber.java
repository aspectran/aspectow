...
@Component
@Bean
public class RandomChatMessageSubscriber extends RedisPubSubAdapter<String, String>
        implements InitializableBean, DisposableBean {

    private static final Logger logger = LoggerFactory.getLogger(RandomChatMessageSubscriber.class);
    ...
    @Autowired
    public RandomChatMessageSubscriber(RedisConnectionPool connectionPool,
