 ...
 */
package aspectow.demo.chat;

import aspectow.demo.chat.codec.ChatMessageDecoder;
import aspectow.demo.chat.codec.ChatMessageEncoder;
import aspectow.demo.chat.model.ChatMessage;
import aspectow.demo.chat.model.payload.BroadcastAvailableUsersPayload;
import aspectow.demo.chat.model.payload.BroadcastConnectedUserPayload;
import aspectow.demo.chat.model.payload.BroadcastDisconnectedUserPayload;
import aspectow.demo.chat.model.payload.BroadcastTextMessagePayload;
...
public class ChatServerEndpoint extends InstantActivitySupport {
    ...
    @OnMessage
    public void onMessage(@NonNull Session session, @NonNull ChatMessage chatMessage) {
