    ...
    <div class="body shadow cell auto cell-block-container">
        <div class="grid-x full-height">
            <div class="sidebar cell medium-4 large-3 cell-block-y hide-for-small-only">
                <p style="position: absolute; bottom: 0; right: 20px;"><a href="?locale=en">English</a></p>
            </div>
            <div class="cell auto cell-block-y">
                <div class="grid-container grid-x t15">
                    ...
                    <div class="cell t15 large-order-3">
                        ...
                        <h4>5. 개인정보 보호책임자</h4>
                        <p>개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 고객의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
                        <ul>
                            <li>책임자: 정주호(운영 및 제작자)</li>
                            <li>연락처: aspectran@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
