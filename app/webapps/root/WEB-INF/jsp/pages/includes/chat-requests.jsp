...
<div class="chat-requests t15">
    ...
    <div class="canceled-request template grid-x grid-padding-x grid-padding-y">
        <div class="cell">
            <p class="title"><aspectran:message code='chat.stranger.canceled_request'/></p>
        </div>
    </div>
    <div class="request-canceled template grid-x grid-padding-x grid-padding-y">
        <div class="cell">
            <p class="title"><aspectran:message code='chat.stranger.request_canceled'/></p>
        </div>
    </div>
    <div class="declined-request template grid-x grid-padding-x grid-padding-y">
        <div class="cell">
            <p class="title"><aspectran:message code='chat.stranger.declined_request'/></p>
        </div>
    </div>
    <div class="request-declined template grid-x grid-padding-x grid-padding-y">
        <div class="cell">
            <p class="title"><aspectran:message code='chat.stranger.request_declined'/></p>
        </div>
    </div>
    <div class="request-timeout template grid-x grid-padding-x grid-padding-y">
        <div class="cell">
            <p class="title"><aspectran:message code='chat.stranger.request_timeout'/></p>
        </div>
    </div>
    <div class="exceeded-requests template grid-x grid-padding-x grid-padding-y">
        <div class="cell">
