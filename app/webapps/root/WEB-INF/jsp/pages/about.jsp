        ...
        <div class="grid-x full-height">
            ...
            <div class="cell auto cell-block-y">
                <div class="grid-container grid-x t15">
                    <div class="cell">
                        <h3>Text Chat Club 소개</h3>
                        <ul>
                            <li>당신과 같은 관심사를 공유하는 새로운 사람들을 만나십시오.</li>
                            <li>서비스를 이용하기 위한 별도의 가입 절차가 없으며, 자신의 대화명만 정하면 됩니다.</li>
                    ...
                    <div class="cell t15">
                        ...
                        <h4>2. 개인정보 수집 항목</h4>
                        <p>서비스 제공을 위해 수집되는 개인정보 항목은 다음과 같습니다.<br/>
                        ...
                        <ul>
                            ...
                            <li>쿠키 주 사용 목적은 고객을 식별하기 위한 것이며, 이용자의 편의를 위한 목적으로 사용되기도 합니다.</li>
