...
<link rel="stylesheet" type="text/css" href="/assets/css/page-common.css?v43"/>
...
<script src="/assets/js/utils.js?v6"></script>
<script src="/assets/js/page-common.js?v31"></script>
<script>
