...
CREATE TABLE asc_build_history (
    ...
    git_commit_before VARCHAR2(64),
    git_commit_after VARCHAR2(64),
    git_commit_msg VARCHAR2(500),
    integrity_hash VARCHAR2(64),
    error_summary VARCHAR2(1000),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    PRIMARY KEY (history_id)
);

CREATE INDEX idx_asc_build_hist_exec ON asc_build_history (execution_id, target_node_id);
